...
public class IndexedIntListIterator extends AbstractIntIterator implements IntListIterator {
  private final IntListIterator myIndexes;
  private final IntList mySource;
  private boolean myIterated;

  public IndexedIntListIterator(IntList source, IntListIterator indexIterator) {
    mySource = source;
