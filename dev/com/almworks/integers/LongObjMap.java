...
public interface LongObjMap<T> extends LongObjIterable<T> {
  LongObjMap EMPTY = new LongObjEmptyMap();
   ...
   */
  boolean containsAnyKeys(LongIterable keys);
   ...
   * {@link LongObjMap} and both objects contain exactly the same key-value pairs,
