...
public interface WritableLongLongMap extends LongLongMap {
   ...
   * @return this
   */
  WritableLongLongMap add(long key, long value);
   ...
   */
  boolean putIfAbsent(long key, long value);
   ...
   * @see #putAll(LongSizedIterable, LongSizedIterable)
   */
  void putAll(LongLongIterable entries);

  /**
   * @throws IllegalArgumentException if {@code keys.size() != values.size()}
   * @see #putAll(long[], long[])
   */
  void putAll(LongSizedIterable keys, LongSizedIterable values);
   ...
   */
  void putAll(long[] keys, long[] values);
   ...
   */
  void putAllKeys(LongIterable keys, LongIterable values);
