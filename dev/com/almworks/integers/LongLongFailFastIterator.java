...
public abstract class LongLongFailFastIterator extends AbstractLongLongIterator {
  private final LongLongIterator myIterator;
  private final int myModCountAtCreation = getCurrentModCount();

  protected abstract int getCurrentModCount();

  public LongLongFailFastIterator(LongLongIterator it) {
    myIterator = it;
  }
  ...
  public LongLongIterator next() throws ConcurrentModificationException, NoSuchElementException {
    checkMod();
    myIterator.next();
    return this;
  }
