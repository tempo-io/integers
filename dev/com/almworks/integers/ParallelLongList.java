...
/**
 * A square array, which is internally stored as one {@code WritableLongList}. <br>
 ...
 */
public class ParallelLongList {
  private final WritableLongList myStorage;
  private final int myListCount;

  public ParallelLongList(WritableLongList storage, int listCount) {
    if (storage == null)
  ...
  public class Iterator {
    ...
    public Iterator(WritableLongListIterator it) {
      myIt = it;
    }
  ...
  private class MyList extends AbstractLongList {
    ...
    public int size() {
      return ParallelLongList.this.size();
    }
