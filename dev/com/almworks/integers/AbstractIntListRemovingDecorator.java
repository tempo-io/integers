...
// CODE GENERATED FROM com/almworks/integers/AbstractPListRemovingDecorator.tpl
...
public abstract class AbstractIntListRemovingDecorator extends AbstractIntListDecorator {
  protected AbstractIntListRemovingDecorator(IntList base) {
    super(base);
  }
  ...
  private class LocalIterator extends AbstractIntListIndexIterator {
    ...
    protected int absget(int index) {
      if (index == index()) {
        ...
        return AbstractIntListRemovingDecorator.this.get(index);
      }
    }
  }
}
