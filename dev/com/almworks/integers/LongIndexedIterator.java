...
// CODE GENERATED FROM com/almworks/integers/PIndexedIterator.tpl
...
public class LongIndexedIterator extends AbstractLongIteratorWithFlag {
  private final LongList myList;
  private final IntIterator myIndexIterator;

  public LongIndexedIterator(LongList list, IntIterator indexIterator) {
    myList = list;
