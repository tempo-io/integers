...
public class IntChainHashSet extends AbstractWritableIntSet implements WritableIntSet {
  private int[] myHead;
  private int[] myNext;
  private int[] myKeys;
   ...
   */
  public IntChainHashSet(int initialCapacity, float loadFactor) {
   ...
   * @see #IntChainHashSet(int, float)
   */
  public IntChainHashSet(int initialCapacity){
   ...
   */
  public static IntChainHashSet createForAdd(int count, float loadFactor) {
    int initialCapacity = (int)(count / loadFactor) + 1;
    return new IntChainHashSet(initialCapacity, loadFactor);
  }
   ...
   */
  public static IntChainHashSet createForAdd(int count) {
  ...
  private void resize(int newCapacity) {
    ...
    int[] keysNew = new int[thresholdNew];
    keysNew[0] = 0;
  ...
  protected boolean include1(int value) {
  ...
  protected void toNativeArrayImpl(int[] dest, int destPos) {
    // todo add 2 variants: below and new IntArray(iterator()) if myRemoved.cardinality() > size() / 10
