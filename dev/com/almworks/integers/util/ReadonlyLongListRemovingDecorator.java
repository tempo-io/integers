...
// CODE GENERATED FROM com/almworks/integers/util/ReadonlyPListRemovingDecorator.tpl
 ...
 */
public class ReadonlyLongListRemovingDecorator extends LongListRemovingDecorator {
  private IntList myRemovedSorted;

  protected ReadonlyLongListRemovingDecorator(LongList base) {
    super(base);
  }

  private ReadonlyLongListRemovingDecorator(LongList base, IntList preparedIndices) {
    super(base);
   ...
   * @return
   */
  public static ReadonlyLongListRemovingDecorator createFromPrepared(LongList base, IntList preparedIndices) {
    return new ReadonlyLongListRemovingDecorator(base, preparedIndices);
  }
