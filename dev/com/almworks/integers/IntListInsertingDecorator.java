...
public class IntListInsertingDecorator extends AbstractIntListDecorator {
  private final IntIntMap myInserted;

  private IntListInsertingDecorator(IntList base, IntIntMap inserted) {
    super(base);
    myInserted = inserted;
  }

  public IntListInsertingDecorator(IntList base) {
    this(base, new IntIntMap());
  }
  ...
  private class LocalIterator extends AbstractIntListIndexIterator {
    private IntIterator myBaseIterator = base().iterator();
    private PairIntIntIterator myInsertedIterator;
