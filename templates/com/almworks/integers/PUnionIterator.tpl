 ...
 * @author Eugene Vagin
 */
public class #E#UnionIterator extends #E#SetOperationsIterator {
  private boolean myIsHeapBuilt = false;

  public #E#UnionIterator(#E#Iterable ... iterables) {
    super(#e#IterablesToIterators(Arrays.asList(iterables)));
  }

  public #E#UnionIterator(List<? extends #E#Iterable> iterables) {
