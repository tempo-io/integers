 ...
 * both lists
 */
public class SortedIntListUnionIterator extends FindingIntIterator {
  ...
  public SortedIntListUnionIterator(IntIterator first, IntIterator second) {
    myFirst = first;
    mySecond = second;
  }

  public static SortedIntListUnionIterator create(IntIterable include, IntIterable exclude) {
    return new SortedIntListUnionIterator(include.iterator(), exclude.iterator());
  }
