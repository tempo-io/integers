...
public class #E#ChainHashSet extends AbstractWritable#E#Set implements Writable#E#Set {
  private int[] myHead;
  private int[] myNext;
  private #e#[] myKeys;
   ...
   */
  public #E#ChainHashSet(int initialCapacity, float loadFactor) {
   ...
   * @see ##E#ChainHashSet(int, float)
   */
  public #E#ChainHashSet(int initialCapacity){
   ...
   */
  public static #E#ChainHashSet createForAdd(int count, float loadFactor) {
    int initialCapacity = (int)(count / loadFactor) + 1;
    return new #E#ChainHashSet(initialCapacity, loadFactor);
  }
   ...
   */
  public static #E#ChainHashSet createForAdd(int count) {
  ...
  private int createNode(#e# value) {
    mySize++;
    int res;
  ...
  protected boolean include1(#e# value) {
  ...
  protected void toNativeArrayImpl(#e#[] dest, int destPos) {
    // todo add 2 variants: below and new #E#Array(iterator()) if myRemoved.cardinality() > size() / 10
