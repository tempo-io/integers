...
public abstract class #E##F#FindingIterator extends Abstract#E##F#Iterator {
  protected #e# myNextLeft = 0xDEADBEEF;
  private #e# myCurrentLeft;
  protected #f# myNextRight = 0xDEADBEEF;
  private #f# myCurrentRight;
