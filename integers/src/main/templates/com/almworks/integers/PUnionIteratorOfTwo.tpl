...
public class #E#UnionIteratorOfTwo extends #E#FindingIterator {
  private final #E#Iterator myIts[] = new #E#Iterator[2];
  private int myItsCount = 2;
  private #e#[] v = {0, 0};

  public #E#UnionIteratorOfTwo(#E#Iterable first, #E#Iterable second) {
